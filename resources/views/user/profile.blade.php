            ...
            <div class="container">
                <div class="row justify-content-between align-items-center d-flex">
                    ...
                    <h1 class="text-white mb-20">{{ $author->name }}</h1>
                        ...
                        <li><a href="{{ route('profile',['locale'=>app()->getLocale(),'username'=>$author->username]) }}">{{ $author->name }} </a></li>
                        </ul>
                    </div>
                </div>
            </div>  
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="single-posts col-lg-6 col-sm-6 pb-4">
                                    ...
                                    <div class="detail">
                                    <a href="{{ route('post',['locale'=>app()->getLocale(),'post'=>$post->slug]) }}"><h4 class="pb-20">{{ $post->title }}<br>{{ $post->subtitle}}</h4></a>
