...
@endsection
@section('title') {{$monthName}} - {{$year}} @endsection
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center d-flex">
                    <div class="col-lg-8 top-left">
                        <a href="{{ route('date',['locale'=>app()->getLocale(),'year'=>$year,'month'=>$month])}}">
                            <h1 class="text-white mb-20">{{ $monthName }} - {{ $year }} </h1>
                        </a>
                        <ul>
    ...
    <section class="post-area">
        <div class="container">
            <div class="row justify-content-center d-flex">
                ...
                @endif 
                @if (isset($categorys) && !$posts->isEmpty())
