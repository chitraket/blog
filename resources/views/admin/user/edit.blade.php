                  ...
                  <div class="card-body">
                      <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputtagtitle1" name="name" placeholder="User Name" value="{{$user->name}}" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputtagslug1">User Email</label>
                            <input type="email" class="form-control" id="exampleInputtagslug1" name="email" placeholder="User Email" value="{{$user->email}}" required>
                        </div>
                        {{-- <div class="form-group">
                          <label for="exampleInputtagslug1">User Password</label>
                          <input type="password" class="form-control" id="exampleInputtagslug1" name="password" placeholder="User Password" value="{{$user->password}}" required>
                      </div>--}}
                       <!-- form-group// --> 
                        <div class="form-group">
